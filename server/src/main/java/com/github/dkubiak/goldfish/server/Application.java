package com.github.dkubiak.goldfish.server;
...
public class Application {
    ...
    @Configuration
    @EnableNeo4jRepositories("com.github.dkubiak.goldfish.server.repository")
    static class ApplicationConfig extends Neo4jConfiguration implements CommandLineRunner {

        public ApplicationConfig() {
            setBasePackage("com.github.dkubiak.goldfish.server");
        }
